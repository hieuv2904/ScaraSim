...
% 
%% link 1
VeHinhTru(handles,line1(1,1),line1(2,1),line1(3,2),0.06,0.01,[0.7 0.7 0.7],'FaceAlpha' ,0.2);
VeHinhTru(handles,line1(1,1),line1(2,1),line1(3,2)+0.072,0.06,-0.01,[0.7 0.7 0.7],'FaceAlpha' ,0.2);
VeHinhTru(handles,line1(1,2),line1(2,2),line1(3,2)+0.072,0.06,-0.01,[0.7 0.7 0.7],'FaceAlpha' ,0.2);
VeHinhTru(handles,line1(1,2),line1(2,2),line1(3,2),0.06,0.01,[0.7 0.7 0.7],'FaceAlpha' ,0.2);
...
% % VeHinhTru(handles,line2(1,2),line2(2,2),0.838*d(1)+0.275,0.06,0.0185*d(1),[0.7 0.7 0.7])
...
% %  
fill3(robot_sim,[pp1(1) pp3(1) pp4(1) pp2(1)],[pp1(2) pp3(2) pp4(2) pp2(2)],[line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.072],[0.3010 0.7450 0.9330])
fill3(robot_sim,[pp1(1) pp3(1) pp4(1) pp2(1)],[pp1(2) pp3(2) pp4(2) pp2(2)],[line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.18275],[0.3010 0.7450 0.9330])
fill3(robot_sim,[pp1(1) pp3(1) pp3(1) pp1(1)],[pp1(2) pp3(2) pp3(2) pp1(2)],[line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.18275 line1(3,2)+0.18275],[0.3010 0.7450 0.9330])
fill3(robot_sim,[pp2(1) pp4(1) pp4(1) pp2(1)],[pp2(2) pp4(2) pp4(2) pp2(2)],[line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.18275 line1(3,2)+0.18275],[0.3010 0.7450 0.9330])
fill3(robot_sim,[pp1(1) pp2(1) pp2(1) pp1(1)],[pp1(2) pp2(2) pp2(2) pp1(2)],[line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.18275 line1(3,2)+0.18275],[0.3010 0.7450 0.9330])
fill3(robot_sim,[pp3(1) pp4(1) pp4(1) pp3(1)],[pp3(2) pp4(2) pp4(2) pp3(2)],[line1(3,2)+0.072 line1(3,2)+0.072 line1(3,2)+0.18275 line1(3,2)+0.18275],[0.3010 0.7450 0.9330])
% % 
pp5 = (pp1+pp3)/2;
pp6 = (pp2+pp4)/2;
% % 
fill3(robot_sim,[pp1(1) pp5(1) pp5(1) pp1(1)],[pp1(2) pp5(2) pp5(2) pp1(2)],[line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.2935 line1(3,2)+0.2935],[0.7 0.7 0.7])
fill3(robot_sim,[pp2(1) pp6(1) pp6(1) pp2(1)],[pp2(2) pp6(2) pp6(2) pp2(2)],[line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.2935 line1(3,2)+0.2935],[0.7 0.7 0.7])
fill3(robot_sim,[pp1(1) pp5(1) pp6(1) pp2(1)],[pp1(2) pp5(2) pp6(2) pp2(2)],[line1(3,2)+0.2935 line1(3,2)+0.2935 line1(3,2)+0.2935 line1(3,2)+0.2935],[0.7 0.7 0.7])
fill3(robot_sim,[pp5(1) pp3(1) pp5(1)],[pp5(2) pp3(2) pp5(2)],[line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.2935],[0.7 0.7 0.7]);
fill3(robot_sim,[pp6(1) pp4(1) pp6(1)],[pp6(2) pp4(2) pp6(2)],[line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.2935],[0.7 0.7 0.7]);
fill3(robot_sim,[pp5(1) pp3(1) pp4(1) pp6(1)],[pp5(2) pp3(2) pp4(2) pp6(2)],[line1(3,2)+0.2935 line1(3,2)+0.18275 line1(3,2)+0.18275 line1(3,2)+0.2935],[0.7 0.7 0.7])
% 
% 
%% link3
...
quiver3(line1(1,1), line1(2,1), line1(3,2)+0.1, xUnitVectorLine1(1), xUnitVectorLine1(2), 0, 'r', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1)+0.1, line1(2,1), line1(3,2)+0.1, 'x', 'Color', 'r', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line1(1,1), line1(2,1), line1(3,2)+0.1, yUnitVectorLine1(1), yUnitVectorLine1(2), 0, 'b', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1), line1(2,1)+0.1, line1(3,2)+0.1, 'y', 'Color', 'b', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line1(1,1), line1(2,1), line1(3,2)+0.1, 0, 0, 0.1, 'g', 'LineWidth', 1, 'MaxHeadSize', 1);
...
quiver3(line2(1,1), line2(2,1), line2(3,2)+0.2935, xUnitVectorLine2(1), xUnitVectorLine2(2), 0, 'r', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1)+0.1, line1(2,1), line1(3,2)+0.1, 'x', 'Color', 'r', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line2(1,1), line2(2,1), line2(3,2)+0.2935, yUnitVectorLine2(1), yUnitVectorLine2(2), 0, 'b', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1), line1(2,1)+0.1, line1(3,2)+0.1, 'y', 'Color', 'b', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line2(1,1), line2(2,1), line2(3,2)+0.2935, 0, 0, 0.1, 'g', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1), line1(2,1), line1(3,2)+0.2, 'Z', 'Color', 'g', 'FontSize', 12, 'FontWeight', 'bold');
...
quiver3(line3(1,1), line3(2,1), line3(3,2)+0.6, xUnitVectorLine3(1), xUnitVectorLine3(2), 0, 'r', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1)+0.1, line1(2,1), line1(3,2)+0.1, 'x', 'Color', 'r', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line3(1,1), line3(2,1), line3(3,2)+0.6, yUnitVectorLine3(1), yUnitVectorLine3(2), 0, 'b', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1), line1(2,1)+0.1, line1(3,2)+0.1, 'y', 'Color', 'b', 'FontSize', 12, 'FontWeight', 'bold');
quiver3(line3(1,1), line3(2,1), line3(3,2)+0.6, 0, 0, -0.1, 'g', 'LineWidth', 1, 'MaxHeadSize', 1);
%text(line1(1,1), line1(2,1), line1(3,2)+0.2, 'Z', 'Color', 'g', 'FontSize', 12, 'FontWeight', 'bold');
